...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False):
  ...
  """
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 5,
...
def run_gpt_prompt_daily_plan(persona,
  ...
  """
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 500,
...
def run_gpt_prompt_generate_hourly_schedule(persona,
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 50,
...
def run_gpt_prompt_task_decomp(persona,
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 1000,
...
def run_gpt_prompt_action_sector(action_description,
    ...
    # gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 15,
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False):
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 30,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
...
def run_gpt_prompt_decide_to_talk(persona, target_persona, retrieved, test_input=None,
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 20,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_keyword_to_thoughts(persona, keyword, concept_summary, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 40,
                 "temperature": 0.7, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_event_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    # gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 3,
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 150,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_agent_chat(maze, persona, target_persona,
    ...
    # gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 2000,
    #              "temperature": 0.7, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_prompt_generate_next_convo_line(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None,
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 250,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
...
def run_gpt_generate_iterative_chat_utt(maze, init_persona, target_persona, retrieved, curr_context, curr_chat,
    ...
    def create_prompt_input(maze, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None):
        ...
        prompt_input = [init_persona.scratch.get_str_iss(), init_persona.scratch.name, retrieved, prev_convo_insert,
...
def run_gpt_update_relationship(init_persona, target_persona, cur_chat, summary):
    self_information = init_persona.scratch.get_str_iss()

    relationship = init_persona.scratch.get_relationship_feeling(target_persona.scratch.name)

    conversation = ""
    for chat in cur_chat:
        conversation += f"{chat[0]}:{chat[1]}\n"
    ...
    prompt_input = f"Here is the personal information about {init_persona.scratch.name}:\n" \
                   f"{self_information}\n\n" \
                   f"Here is the current thoughts in {init_persona.scratch.name}'s head:\n" \
                   f"{summary}\n\n" \
                   f"Here is the conversation between {init_persona.scratch.name} and {target_persona.scratch.name}:\n" \
                   f"{conversation}\n\n" \
                   f"Current relationship between {init_persona.scratch.name} and {target_persona.scratch.name}:" \
                   f"{relationship['relationship']}\n" \
                   f"Current {init_persona.scratch.name}'s feeling about {target_persona.scratch.name}:" \
                   f"{relationship['feeling']}\n\n" \
                   f"From about information, do you need to update the relationship between " \
                   f"{init_persona.scratch.name} and {target_persona.scratch.name}." \
                   f" And how {init_persona.scratch.name} feel about {target_persona.scratch.name}?\n" \
...
def run_gpt_extra_plan(persona,
                       test_input=None,
                       verbose=False):
    """
  Return the extra plan which is different from the persona's lifestyle
  ...
  """
    ...
    def create_prompt_input(persona, test_input=None):
        ...
        prompt_input = []
        prompt_input += [persona.scratch.get_str_firstname()]
        prompt_input += [persona.scratch.get_str_iss_without_Currently()]
        return prompt_input

    def __func_clean_up(gpt_response, prompt=""):
        json_data = json.loads(gpt_response)
        assert "output" in json_data.keys(), "run_gpt_extra_plan -> gpt_response should be a dict with the key 'output'"
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 500,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/lifestyle/extra_plan.txt"
    prompt_input = create_prompt_input(persona, test_input)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe()

    output = ChatGPT_safe_generate_response_temperature(prompt, 3, fail_safe, 1, __func_validate, __func_clean_up)
    # output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
    #                                 __func_validate, __func_clean_up)
    # output = ([f"wake up and complete the morning routine at {wake_up_hour}:00 am"]
    #           + output)
...
def run_gpt_next_day_extra_plan(persona,
                                additional_information,
                                test_input=None,
                                verbose=False):
    """
  Return the extra plan which is different from the persona's lifestyle for next day
  ...
  """
    ...
    def create_prompt_input(persona, additional_information, test_input=None):
        if test_input: return test_input
        prompt_input = []
        prompt_input += [persona.scratch.get_str_firstname()]
        prompt_input += [persona.scratch.get_str_iss_without_Currently()]
        ...
        for i, v in enumerate(additional_information):
            additional_information_str += f"{i + 1}. {v}\n"
        prompt_input += [additional_information_str]
        return prompt_input

    def __func_clean_up(gpt_response, prompt=""):
        json_data = json.loads(gpt_response)
        assert isinstance(json_data, list), "run_gpt_extra_plan -> json_data should be a list"
        assert "output" in json_data[
            0].keys(), "run_gpt_extra_plan -> gpt_response should be a dict with the key 'output'"
        return json_data
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 500,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/lifestyle/next_day_extra_plan.txt"
    prompt_input = create_prompt_input(persona, additional_information, test_input)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe()
...
def run_gpt_prompt_daily_plan_with_extra_plan(persona,
                                              extra_plan,
                                              wake_up_hour,
                                              test_input=None,
                                              verbose=False):
    """
  Basically the long term planning that spans a day with extra plan. Returns a list of actions
  that the persona will take today. Usually comes in the following form:
  'wake up and complete the morning routine at 6:00 am',
  'eat breakfast at 7:00 am',..
  Note that the actions come without a period.
  ...
  """
    ...
    def create_prompt_input(persona, extra_plan, wake_up_hour, test_input=None):
        if test_input: return test_input
        prompt_input = []
        prompt_input += [persona.scratch.name]
        prompt_input += [persona.scratch.get_str_iss()]
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 500,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/lifestyle/new_day_with_extra_plan.txt"
    prompt_input = create_prompt_input(persona, extra_plan, wake_up_hour, test_input)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe()
...
def run_gpt_prompt_next_day_plan_with_extra_plan(persona,
                                                 wake_up_hour,
                                                 plan_note,
                                                 summary_thoughts,
                                                 extra_plan,
  ...
  """
    ...
    def create_prompt_input(persona, wake_up_hour, plan_note, summary_thoughts, extra_plan, test_input=None):
        if test_input: return test_input
        prompt_input = []
        prompt_input += [persona.scratch.name]
        prompt_input += [persona.scratch.get_str_iss()]
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 500,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/lifestyle/next_day_daily_plan_with_extra_plan.txt"
    prompt_input = create_prompt_input(persona, wake_up_hour, plan_note, summary_thoughts, extra_plan, test_input)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe()
...
def run_gpt_prompt_task_decomp_with_extra_mind(persona,
                                               task,
                                               duration,
                                               extra_mind,
                                               test_input=None,
                                               verbose=False):
    def create_prompt_input(persona, task, duration, extra_mind, test_input=None):
    ...
    """
        ...
        for index in all_indices:
            ...
            if index < len(persona.scratch.f_daily_schedule_hourly_org):
                ...
                start_time_str = start_time.strftime("%H:%M%p")
                end_time_str = end_time.strftime("%H:%M%p")
                summ_str += f"{start_time_str} ~ {end_time_str} {persona.scratch.f_daily_schedule_hourly_org[index][0]}."
                if curr_f_org_index + 1 == index:
                    curr_time_range = f'{start_time_str} ~ {end_time_str}'
        # summ_str = summ_str[:-2] + "."
    ...
    def __func_clean_up(gpt_response, prompt=""):
        ...
        assert isinstance(json_data, list), "run_gpt_prompt_task_decomp_with_extra_mind -> json_data should be a list"
        assert "activity" in json_data[0].keys(), "run_gpt_prompt_task_decomp_with_extra_mind -> activity should be " \
                                                  "in the keys "
        assert "duration" in json_data[0].keys(), "run_gpt_prompt_task_decomp_with_extra_mind -> activity should be " \
                                                  "in the keys "
        assert "left time" in json_data[0].keys(), "run_gpt_prompt_task_decomp_with_extra_mind -> activity should be " \
                                                   "in the keys "
        return json_data
    ...
    gpt_param = {"engine": "gpt-35-turbo-instruct", "api_type": "azure", "max_tokens": 1000,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/lifestyle/task_decomp_with_extra_mind.txt"
    prompt_input = create_prompt_input(persona, task, duration, extra_mind)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe()
